...
def main():
    if len(sys.argv) != 4:
        print("Uso: python exercise_13a_minimum.py input.txt input.pgm output.pgm")
        sys.exit(2)
    ...
    resultado = es_minimo_regional(matriz, ancho, alto, zona, valor, conectividad)

    with open("exercise_13a_output.txt", "w", encoding="utf-8") as f:
